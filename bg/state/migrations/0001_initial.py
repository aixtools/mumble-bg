# Generated by Django 5.0.14 on 2026-03-18 11:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('acl_sync', 'ACL Sync'), ('murmur_user_created', 'Murmur User Created'), ('password_changed', 'Password Changed')], max_length=64)),
